<%-- 
    Document   : index
    Created on : Mar 15, 2023, 11:17:55 PM
...
<html>
    <head>
        ...
        <style>
            .banner-background
            {
                clip-path: polygon(30% 0%, 100% 0, 100% 30%, 100% 89%, 65% 99%, 31% 91%, 0 94%, 0 0);         
            }
        </style>        
    </head>
    <body>
        ...
        <div class="container-fluid p-0 m-0 banner-background">
            <div class="jumbotron primary-background text-white">
                <div class="container">
                    ...
                    <button class="btn-outline-light  btn-lg"><span class="fa fa-user-plus"></span>Satrt ! its Free</button>
